    ...
    return (
      ...
      `}</style>
            ...
            {showOverlay && (
                ...
                >
                    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm pointer-events-auto" onClick={handleToggle} />
                    <ul
                        className={[
                            'pill-list',
                            'list-none m-0 px-6',
                        ...
                        {menuItems.map((item, idx) => (
                            <li
                                ...
                                className={[
                                    ...
                                    '[flex:0_0_calc(100%/2.2)] lg:[flex:0_0_calc(100%/4.5)]',
                                    'box-border p-0.5'
                                ].join(' ')}
                            >
                                <a
                                    ...
                                    className={[
                                        ...
                                        'box-border',
                                        'whitespace-nowrap overflow-hidden font-skater'
                                    ].join(' ')}
                                    style={{
