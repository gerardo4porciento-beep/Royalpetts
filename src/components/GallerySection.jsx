...
const MarqueeItem = ({ pet, onClick }) => (
    <div
        className="relative flex-shrink-0 w-[320px] h-[280px] mx-0 rounded-[3rem] bg-royal-black overflow-hidden group transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer hover:z-20"
        style={{
    ...
    >
        ...
        />
        {/* Removed blur on hover to keep it crisp, maybe dim it instead? */}
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-100 scale-90">
            {/* Glassmorphism Badge */}
            <div
                className="px-8 py-4 bg-opacity-90 backdrop-blur-md rounded-full shadow-2xl transform  flex justify-center items-center border border-white/20"
                style={{ backgroundColor: pet.color }}
            >
                <h3
                    className="text-[3rem] font-skater text-royal-blue leading-none tracking-wide drop-shadow-lg"
...
const GallerySection = () => {
    ...
    return (
        <section id="gallery" className="relative min-h-screen bg-[#32f4bb] flex flex-col justify-center overflow-hidden py-24">
