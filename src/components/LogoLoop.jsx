                ...
                {items.map((_, index) => (
                    <div key={index} className="flex items-center gap-10 mx-10 flex-shrink-0">
                        ...
                        <img
                            ...
                            className="w-24 h-24 md:w-32 md:h-32 lg:w-44 lg:h-44 object-contain flex-shrink-0 brightness-0 invert drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] rotate-[-3deg]"
                        />
                    </div>
                ))}
            </div>
